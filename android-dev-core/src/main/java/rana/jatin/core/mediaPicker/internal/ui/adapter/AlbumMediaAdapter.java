 ...
 */
package rana.jatin.core.mediaPicker.internal.ui.adapter;
...
import rana.jatin.core.mediaPicker.internal.entity.IncapableCause;
...
import rana.jatin.core.mediaPicker.internal.ui.widget.CheckView;
import rana.jatin.core.mediaPicker.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            mediaViewHolder.mMediaGrid.getmCheckView().setVisibility(mSelectionSpec.singleSelectionModeEnabled() ? View.GONE : View.VISIBLE);
