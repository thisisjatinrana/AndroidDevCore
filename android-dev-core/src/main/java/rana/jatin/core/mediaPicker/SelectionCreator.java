...
import rana.jatin.core.mediaPicker.engine.ImageEngine;
import rana.jatin.core.mediaPicker.filter.Filter;
...
import rana.jatin.core.mediaPicker.listener.OnCheckedListener;
import rana.jatin.core.mediaPicker.listener.OnSelectedListener;
...
public final class SelectionCreator {
     ...
     *
     * @param mediaPicker a requester context wrapper.
     * @param mimeTypes   MIME type set to select.
     */
    SelectionCreator(MediaPicker mediaPicker, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
     ...
     * 1. {@link rana.jatin.core.mediaPicker.engine.impl.GlideEngine}
     ...
     * <p>
     * It's a redundant API with {@link MediaPicker#obtainResult(Intent)},
    ...
    public void forResult(int requestCode) {
        ...
        Fragment fragment = mMediaPicker.getFragment();
        if (fragment != null) {
