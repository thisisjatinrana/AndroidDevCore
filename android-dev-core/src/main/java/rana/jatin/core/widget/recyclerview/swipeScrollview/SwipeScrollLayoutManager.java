...
class SwipeScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    private SwipeScrollItemTransformer itemTransformer;

    public SwipeScrollLayoutManager(
            @NonNull Context c,
    ...
    public boolean canScrollHorizontally() {
        return (isScrollingEnabled && orientationHelper.canScrollHorizontally());
    }

    @Override
    public boolean canScrollVertically() {
        return (isScrollingEnabled && orientationHelper.canScrollVertically());
    }
    ...
    public void setItemTransformer(SwipeScrollItemTransformer itemTransformer) {
