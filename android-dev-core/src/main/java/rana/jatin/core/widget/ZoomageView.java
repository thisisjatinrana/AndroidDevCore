...
public class ZoomageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private GestureDetector.SimpleOnGestureListener gestureCallback;
    private final GestureDetector.OnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onDoubleTapEvent(MotionEvent e) {
            if (e.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (gestureCallback != null)
                    gestureCallback.onDoubleTapEvent(e);
            }
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            if (gestureCallback != null)
                gestureCallback.onSingleTapUp(e);
            return false;
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (gestureCallback != null)
                gestureCallback.onSingleTapConfirmed(e);
            return false;
        }
    ...
    public void setGestureCallback(GestureDetector.SimpleOnGestureListener gestureCallback) {
